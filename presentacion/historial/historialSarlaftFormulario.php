...
?>
<form name="formulario" method="post" action="principal.php?CONTENIDO=presentacion/historial/historialSarlaftActualizar.php" enctype="multipart/form-data">
  ...
  <div class="form-group row">
    <label class="form-label mt-2">ADJUNTO FORMULARIO DE SARLAFT: </label>
  ...
  <a class="btn btn-danger" href="principal.php?CONTENIDO=presentacion/historial/historialSarlaft.php">Cancelar</a>
</form>
