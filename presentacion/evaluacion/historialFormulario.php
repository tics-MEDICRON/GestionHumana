...
<form name="formulario" method="post" action="principal.php?CONTENIDO=presentacion/evaluacion/historialActualizar.php" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <input type="date" name="fecha" valFECHAue="<?= $directorio->getFecha()  ?>" required class="form-control" placeholder="Ingrese el logro">
  </div>
  <br>
  <div class="form-group row">
    <label class="form-label mt-2">EVALUACIÓN DESEMPEÑO: </label>
  ...
  <a class="btn btn-danger" href="principal.php?CONTENIDO=presentacion/evaluacion/historialEvaluacion.php">Cancelar</a>
</form>
